...
import { createChemistry, getChemistriesMap } from './chemistryManager';
import { createFormFactor, getFormFactorMap } from './formfactorManager';
...
export function setupApiRoutes(app: Application, db: Database) {
	...
	app.get('/api/chemistry_details', (req, res) => getChemistriesMap(db, req, res));
	app.get('/api/formfactor_details', (req, res) => getFormFactorMap(db, req, res));
	...
	app.post('/api/create_formfactor', (req, res) => createFormFactor(db, req, res));
	app.post('/api/create_chemistry', (req, res) => createChemistry(db, req, res));
